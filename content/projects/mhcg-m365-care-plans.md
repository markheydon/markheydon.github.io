---
title: "Microsoft 365 Care Plans"
date: 2025-11-01
...
links:
  - icon: fas fa-link
    url: https://markheydon.co.uk/care-plans/
---
...
- **Security posture**
  ...
  - Safe‑links/attachments, anti‑phishing, DKIM/DMARC guidance
- **Collaboration setup**
  - SharePoint site structure and permissions model
  - OneDrive safeguards and sharing controls
  - Teams sensible defaults (notifications, guest access posture)
- **Tenant hygiene**
  - Admin roles and break‑glass account strategy
  - Mailbox policies, retention tags, and naming standards
  - License assignment conventions and user lifecycle
- **Device management (Premium)**
  - Intune enrolment, compliance and configuration profiles
  - Endpoint security baselines, Defender settings, update rings
  - App deployment (Office, business apps) and autopilot‑style onboarding
- **Operational care**
  - Monthly checks and recommendations
  - Change tracking and lightweight documentation
...
- **Microsoft Entra ID** — MFA, Conditional Access, role management
